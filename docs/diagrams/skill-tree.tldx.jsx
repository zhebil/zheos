  ...
  return (
    <Doc title="zheos skill tree" layout="col" gap="60" align="center">
      ...
      <Group id="tree" layout="row" gap="46" align="center">
        ...
        <Skill id="ground" name="GROUND" note="linker, stack, .bss" color="green" />
        <Skill id="rustcore" name="RUST CORE" note="no_std, kmain" color="green" />

        <Group id="branches" layout="col" gap="60" align="start">
          <Branch id="io">
            <Skill id="uart" name="UART" note="PL011 driver" color="green" />
            <Skill id="print" name="PRINT" note="core::fmt::Write" color="green" />
            <Skill id="wozmon" name="WOZMON" note="a live monitor" color="green" />
          </Branch>
          ...
          <Branch id="irq">
            <Skill id="interrupts" name="INTERRUPTS" note="vectors + GIC" color="orange" />
