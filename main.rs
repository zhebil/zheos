...
mod uart {
    ...
    mod fr {
        // TODO: move to separate file and fix path issue
        pub const BUSY: u32 = super::super::bit_mask(3);
        pub const TXFF: u32 = super::super::bit_mask(5);
    }

    mod lcr_h {
        pub const FEN: u32 = super::super::bit_mask(4);
